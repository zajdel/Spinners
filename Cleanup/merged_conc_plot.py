...
def graph_conc(features,features2):
    ...
    for nn in NN:
        ...
        for con in conc:
            ...
            yfit.append(avg)
            k = 1
            ax.errorbar(c_vals[con], avg2, yerr=std2,fmt='^',ecolor=colors[k],c=colors[k],capsize=5,markersize=10, elinewidth=2, capthick=2)
            k=0
    ...
    for pre in conc:
        ...
        for i in range(file_num):
            ...
            if pre == "control":
                ...
                csv_name2 = path + pre + str(i+1) + "_checked"+ ".csv"
